...
private:
	...
	///
	/// Conditionally log formatted data
	///
	/// \param inDriver    driver index, matched against mLogMask
	/// \param inFormat    data to log
	///
	void		FLogLine( KUInt32 inDriver, const char* inFormat, ... );
