...
public:
	...
	void ResetTxBEmpty() { mSerialStatus |= kSerialTxBufferEmpty; }
	virtual KUInt8 GetByte() = 0;
	bool TxBufEmpty() { return mSerialStatus & kSerialTxBufferEmpty; }
	bool RxBufFull() { return mSerialStatus & kSerialRxCharAvailable; }
	SerialStatus GetSerialStatus() { return mSerialStatus; }
	void ResetSerialStatus() { mSerialStatus = 0; }
	virtual void SetSerialOutputs(SerialOutputControl) = 0;
	virtual void ClearSerialOutputs(SerialOutputControl) = 0;
	SerialOutputControl GetSerialOutputs() { return mSerialOutputs; }
	...
	SerialFeatures GetFeatures() { return kSerFeatureDefaults | kSerFeatureEinstein; }
