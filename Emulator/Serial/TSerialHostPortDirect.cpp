...
TSerialHostPortDirect::TSerialHostPortDirect(
	...
	:
		...
		, mReadBuffer( nullptr )
{
	mFile = open( mPath, O_RDWR | O_NOCTTY | O_NONBLOCK );
	if (mFile != -1)
	{
...
void TSerialHostPortDirect::PutByte(KUInt8 nextChar)
{
...
KUInt8 TSerialHostPortDirect::GetByte()
{
	KUInt8 data;
	mReadMutex->Lock();
...
void TSerialHostPortDirect::SetSerialOutputs(SerialOutputControl)
{
}

void TSerialHostPortDirect::ClearSerialOutputs(SerialOutputControl)
{
}

void TSerialHostPortDirect::SetInterruptEnable(bool enable)
{
}

void TSerialHostPortDirect::Reset()
{
}

void TSerialHostPortDirect::SetBreak(bool assert)
{
}


InterfaceSpeed TSerialHostPortDirect::SetSpeed(BitRate bitsPerSec)
{
	return 0;
}

void TSerialHostPortDirect::SetIOParms(TCMOSerialIOParms* opt)
{
}

void TSerialHostPortDirect::Reconfigure()
{
}

KSInt32 TSerialHostPortDirect::InitByOption(TOption* initOpt)
{
	return 0;
}

KSInt32 TSerialHostPortDirect::ProcessOption(TOption* opt)
{
	return 0;
}

KSInt32 TSerialHostPortDirect::SetSerialMode(SerialMode mode)
{
	return 0;
}

RxErrorStatus TSerialHostPortDirect::GetByteAndStatus(KUInt8* nextCharPtr)
{
	return 0;
}

bool TSerialHostPortDirect::AllSent()
{
	return true;
}


KSInt32 TSerialHostPortDirect::WaitForAllSent()
{
	return 0;
}

void TSerialHostPortDirect::Run()
{
	fd_set fdSet;
	while (true)
	{
