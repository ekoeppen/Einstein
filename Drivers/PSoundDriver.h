...
public:
	...
	NONVIRTUAL ULong	OutputIntHandlerDispatcher( void );
	NONVIRTUAL ULong	InputIntHandlerDispatcher( void );
	...
	NONVIRTUAL ULong	OutputIntHandlerDispatcher_717006( void );
	NONVIRTUAL ULong	OutputIntHandlerDispatcher_737041( void );
	NONVIRTUAL ULong	OutputIntHandlerDispatcher_747129( void );
	NONVIRTUAL ULong	InputIntHandlerDispatcher_717006( void );
	NONVIRTUAL ULong	InputIntHandlerDispatcher_737041( void );
	NONVIRTUAL ULong	InputIntHandlerDispatcher_747129( void );
};
